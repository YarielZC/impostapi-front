  ...
  return (
    ...
    > 
      <div className='flex flex-col gap-2 '>
        <p className='text-white text-xl z-20 max-sm:text-lg'>{title}</p>
        <p className=' text-sm text-[var(--secondary-text-color)] z-20 max-sm:text-xs'>{description}</p>
      </div>

      <p className='text-[#5146ce] text-2xl z-20 flex font-bolds font-mono justify-center items-center w-fit max-sm:text-lg'>{`${percent}`}%</p>
