...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className='flex flex-col gap-4 py-32 px-44 justify-center items-center w-full'>
        <h4 className='text-center font-bold text-4xl'>¿Por qué ImpostAPI?</h4>
        <p className='w-1/3 text-center text-[var(--secondary-text-color)]'>Diseñado para velocidad, flexibilidad y felicidad del desarrollador. No sigas luchando con las demoras del equipo de backend.</p>

        <div className='grid grid-rows-2 grid-cols-3 gap-6 mt-16 px-12'>
          <CardExplain 
      ...
      <section className='flex flex-col gap-6 items-center justify-center border-t-2 border-[var(--dark-mode-border-color)] py-32 bg-[var(--dark-mode-card-form-color)] '>
        ...
        <p className='w-1/2 text-center text-[var(--secondary-text-color)]'>Este proyecto es completamente gratuito y no necesitas pagar absolutamente nada para utilizar sus funcionalidades. No obstante se agradece un montón cualquier donación que desee hacer a este proyecto y/o ayudarme a crecer como desarrollador. Muchas gracias por estar acá.</p>
